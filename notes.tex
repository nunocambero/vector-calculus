...
We can write $L$ in terms of the dericative of the scalar function $f$:
\[
f : \mathbb{R}^2 \rightarrow \mathbb{R} 
\]
...
\]
\[
= \lim_{(x,y) \to (0,0)} \frac{\frac{2xy}{\sqrt{x^2 + y^2}} - 0 - 0 \cdot x - 0 \cdot y}{\sqrt{x^2 + y^2}} = \lim_{(x,y) \to (0,0)} \frac{2xy}{\sqrt{x^2 + y^2} \cdot \sqrt{x^2 + y^2}} = \lim_{(x,y) \to (0,0)} \frac{2xy}{x^2 + y^2}
\]
...
Where $\frac{v^2}{u}$ is the slope of the tangent line in the direction of $(u,v)$.
